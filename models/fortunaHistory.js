...
const FortunaHistorySchema = new Schema({
    ...
    session_no: String,
    state: Number,          //0: received by test, 1: received by tip, 2: Send, 3: withdraw to FRT token, 4: Rent Great Person, 5: Buy Offer, 6: Sell Offer, 7: Complete mission, 8: enroll tournament, 9: win tournament
    created_at: String,
